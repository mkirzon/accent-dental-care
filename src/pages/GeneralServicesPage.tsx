    ...
    <>
      <section className="pt-28 pb-20 bg-gradient-to-br from-brand-50 via-white to-warm-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-slate-900 mt-2 mb-4">{services.general.headline}</h1>
            <p className="text-xl text-slate-600">{services.general.subheadline}</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-br from-brand-600 to-brand-800 text-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">Ready for Your Next Visit?</h2>
          <p className="text-brand-100 text-lg mb-8">Schedule your cleaning, exam, or treatment today.</p>
